...
final mockProfessional = ProfessionalModel(
    ...
    rating: 4.9,
    reviewCount: 125,
    avatarUrl: 'https://images.unsplash.com/photo-1599305445671-ac291c9a87bb?q=80&w=1770&auto=format&fit=crop',
    backgroundUrl: 'https://images.unsplash.com/photo-1599305445671-ac291c9a87bb?q=80&w=1770&auto=format&fit=crop',
    isVerified: true,
    acceptsWarrantyPayment: true,
    bio: 'مقاول عام بخبرة تزيد عن 15 عامًا في مجال بناء الفلل والمباني السكنية في صنعاء. متخصص في إدارة المشاريع من البداية وحتى التسليم.',
    portfolioImageUrls: [
...
final mockSupplier = SupplierModel(
  ...
  rating: 4.8,
  reviewCount: 210,
  avatarUrl: 'https://images.unsplash.com/photo-1543269865-cbf427effcbb?q=80&w=1770&auto=format&fit=crop',
  deliveryPolicy: 'نوفر خدمة التوصيل داخل صنعاء بتكلفة إضافية. الاستلام من المحل متاح خلال ساعات العمل.',
);
...
final List<ProductModel> mockProducts = [
  ProductModel(
    ...
    price: 4500,
    unit: 'للكيس (50 كجم)',
    imageUrl: 'https://images.unsplash.com/photo-1582234293933-289520e588b3?q=80&w=1770&auto=format&fit=crop',
  ...
  ProductModel(
    ...
    price: 150,
    unit: 'للقطعة',
    imageUrl: 'https://images.unsplash.com/photo-1580211105152-32a18f4e6b1d?q=80&w=1770&auto=format&fit=crop',
    supplierId: 'sup-nahda',
    supplierName: 'مؤسسة النهضة للمقاولات',
  ...
  ProductModel(
    ...
    price: 250,
    unit: 'للقطعة',
    imageUrl: 'https://images.unsplash.com/photo-1601053073041-e97d19e9e1b2?q=80&w=1770&auto=format&fit=crop',
    supplierId: 'sup-nahda',
    supplierName: 'مؤسسة النهضة للمقاولات',
...
final List<ChatThreadModel> mockChatThreads = [
  ChatThreadModel(
    ...
    otherPartyAvatarUrl: 'https://images.unsplash.com/photo-1599305445671-ac291c9a87bb?q=80&w=1770&auto=format&fit=crop',
  ...
  ChatThreadModel(
    ...
    otherPartyAvatarUrl: 'https://images.unsplash.com/photo-1543269865-cbf427effcbb?q=80&w=1770&auto=format&fit=crop',
...
final Map<String, List<ChatMessageModel>> mockChatMessages = {
  'chat-1': [
    ...
    ChatMessageModel(
      id: 'msg-1-2',
      text: 'وعليكم السلام، يمكننا البدأ غداً صباحاً إن شاء الله. سأرسل لك صور حديد التسليح للمعاينة.',
